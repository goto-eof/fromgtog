...
<h1 align="right" id="title">FromGtoG v. 9.1.3</h1>

<h2 id="index">Index</h2>

- [Introduction](#introduction)
- [Features](#features)
- [Download FromGtoG 9.1.3](#download)
...
# FromGtoG 9.1.3: Advanced Git Repository Backup and Migration Utility
...
<h2 id="download">Download FromGtoG 9.1.3</h2>

| Platform           | AMD64 Installer                                                                                                          | ARM64 Installer                                                                                                                  | Other Installation Method(s)                                                                                                                                |
|:-------------------|:-------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **MacOS**          | [Installer ZIP](https://github.com/goto-eof/fromgtog/releases/download/9.1.3/fromgtog-MacOS-9.1.3-amd64-Installer.zip)   | [Installer ZIP](https://github.com/goto-eof/fromgtog/releases/download/9.1.3/fromgtog-MacOS-9.1.3-arm64-Installer.zip)           | N/A                                                                                                                                                         | |
| **Windows**        | [Installer ZIP](https://github.com/goto-eof/fromgtog/releases/download/9.1.3/fromgtog-Windows-9.1.3-amd64-Installer.zip) | N/A                                                                                                                              | N/A                                                                                                                                                         |
| **Debian**         | [Installer ZIP](https://github.com/goto-eof/fromgtog/releases/download/9.1.3/fromgtog-Linux-9.1.3-amd64-Installer.zip)   | **Snap Store (AMD64/ARM64):** [Install Link](https://snapcraft.io/fromgtog)<br>**Comment:** Or run `sudo snap install fromgtog`. | N/A                                                                                                                                                         |
| **Cross-Platform** | N/A                                                                                                                      | N/A                                                                                                                              | **Jar file:** [Download Link](https://github.com/goto-eof/fromgtog/releases/download/9.1.3/fromgtog.jar)<br>**Comment:** Run with `java -jar fromgtog.jar`. |
