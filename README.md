...
| **Windows**        | [Installer ZIP](https://github.com/goto-eof/fromgtog/releases/download/9.0.10/fromgtog-Windows-9.0.10-amd64-Installer.zip) | N/A                                                                                                                    | N/A                                                                                                                                                         |
| **Debian**         | [Installer ZIP](https://github.com/goto-eof/fromgtog/releases/download/9.0.10/fromgtog-Linux-9.0.10-amd64-Installer.zip)   | N/A                                                                                                                    | **Snap Store (AMD64/ARM64):** [Install Link](https://snapcraft.io/fromgtog)<br>**Comment:** Or run `sudo snap install fromgtog`.                            |
