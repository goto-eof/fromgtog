...
| **Linux**          | [Ubuntu AMD64 package](https://github.com/goto-eof/fromgtog/releases/download/9.0.0/fromgtog-Linux-9.0.0-amd64-Installer.zip) | N/A                                                                                                                    | **Snapstore (AMD64/ARM64):** [Install Link](https://snapcraft.io/fromgtog)<br>**Comment:** Or run `sudo snap install fromgtog`.                             |
