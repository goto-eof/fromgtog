...
Download
the [zip](https://github.com/goto-eof/fromgtog/releases/download/10.0.7/fromgtog-Linux-10.0.7-amd64-Installer.zip) file
and execute:
...
Download the [.jar](https://github.com/goto-eof/fromgtog/releases/download/10.0.7/fromgtog.jar) file and install JRE 21.
