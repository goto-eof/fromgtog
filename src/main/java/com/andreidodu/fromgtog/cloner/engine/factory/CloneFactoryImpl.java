...
import com.andreidodu.fromgtog.cloner.engine.destination.realengine.GiteaDestinationEngine;
import com.andreidodu.fromgtog.cloner.engine.destination.realengine.GithubDestinationEngine;
import com.andreidodu.fromgtog.cloner.engine.destination.realengine.LocalDestinationEngine;
import com.andreidodu.fromgtog.cloner.exception.DestinationEngineNotFoundException;
import com.andreidodu.fromgtog.cloner.exception.SourceEngineNotFoundException;
import com.andreidodu.fromgtog.cloner.engine.source.SourceEngine;
import com.andreidodu.fromgtog.cloner.engine.source.realengine.GiteaSourceEngine;
import com.andreidodu.fromgtog.cloner.engine.source.realengine.GithubSourceEngine;
import com.andreidodu.fromgtog.cloner.engine.source.realengine.LocalSourceEngine;
