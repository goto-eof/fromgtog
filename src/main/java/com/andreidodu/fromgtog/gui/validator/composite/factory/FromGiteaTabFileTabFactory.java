...
public class FromGiteaTabFileTabFactory implements ComponentValidatorFactory {
    @Override
    public ComponentValidator createValidator() {
        ...
        Predicate<JSONObject> secondaryTabPredicate = isSecondaryTabIndexEqualTo(EngineOptionsType.FILE, FROM_GITEA_OPTIONS_TABBED_PANE_INDEX);
        ...
        buildGiteaFileTab(mainIsApplicableCondition, primaryTab);
