...
public class FromGitlabTabFileTabFactory implements ComponentValidatorFactory {
    @Override
    public ComponentValidator createValidator() {
        ...
        Predicate<JSONObject> secondaryTabPredicate = isSecondaryTabIndexEqualTo(EngineOptionsType.FILE, FROM_GITLAB_OPTIONS_TABBED_PANE_INDEX);
        ...
        buildGitlabFileTab(mainIsApplicableCondition, primaryTab);
