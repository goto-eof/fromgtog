...
import org.andreidodu.fromgtog.service.factory.CloneFactory;
import org.andreidodu.fromgtog.service.factory.CloneFactoryImpl;
...
import static org.andreidodu.fromgtog.constants.ApplicationConstants.ORCHESTRATOR_THREAD_NAME_PREFIX;
import static org.andreidodu.fromgtog.constants.ApplicationConstants.TRAY_ICON_THREAD_NAME_PREFIX;
    ...
    public boolean cloneAllRepositories(EngineContext engineContext) {
        ...
        if (engineContext.settingsContext().chronJobEnabled()) {
            ...
            try {
                ...
                scheduledJobService.runDescriptorThread();
                scheduledJobService
